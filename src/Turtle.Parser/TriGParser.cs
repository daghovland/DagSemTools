...
/// <summary>
/// Parser for the TriG language.
/// </summary>
public static class TriGParser
{
    /// <summary>
    /// Parses the content of the file containing RDF-1.2 TriG. 
    /// </summary>
    ...
    public static Datastore ParseReader(TextReader textReader, UInt32 initSize, Dictionary<string, IriReference> prefixes, TextWriter errorOutput)
    {
        ...
        {
            throw new Exception("Syntax errors in TriG file");
        }
        return listener.datastore;
    }

    /// <summary>
    /// Parses the content of the TextReader containing RDF-1.2 TriG.
    /// </summary>
    /// <param name="textReader"></param>
    /// <param name="initSize"></param>
    /// <param name="errorOutput"></param>
    ...
    /// <summary>
    /// Parses the content of the string containing RDF-1.2 TriG.
    /// </summary>
